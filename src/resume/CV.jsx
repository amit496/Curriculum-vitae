...
let CV = () => {
    return (
        <>
            <div className='w-[70%] m-auto mt-11 p-6 shadow-lg mb-6'>
                <header className='flex justify-between items-start'>
                    <div className='flex items-center'>
                        ...
                        <div className='ml-4'>
                            ...
                            <h1 className='text-4xl font-bold'>Gautam</h1>
                        </div>
                    </div>
                ...
                <div className='education mt-3'>
                    ...
                    <div className='mt-2'>
                        <div className='flex justify-between'>
                            <h2 className='text-l'>Experienced Laravel Developer with expertise in PHP and web application development. Skilled in optimizing performance, delivering scalable solutions, and collaborating with teams to enhance user experience. Focused on writing clean, efficient code and meeting project deadlines.</h2>
                        </div>
                    </div>
                </div>
                ...
                <div className='education mt-3'>
                    ...
                    <div className='mt-2'>
                        <div className='flex justify-between'>
                            <h2 className='text-l'>Diploma in Information Technology</h2>
                            <h1 className="text-l font-semibold">2019 - 2022</h1>
                        </div>
                ...
                <div className="areaofinterest mt-3">
                    ...
                    <div className="mt-2">
                        <div className='flex justify-between items-center'>
                            <h1 className="text-l font-semibold">Laravel Developer</h1>
                            <h1 className="text-l font-semibold">May 2024 - Present</h1>
                        </div>
                        <div>
                    ...
                    <div className="mt-3">
                        <div className='flex justify-between items-center'>
                            <h1 className="text-l font-semibold">Laravel Developer</h1>
                            <h1 className="text-l font-semibold">Mar 2024 - Apr 2024</h1>
                        </div>
                        <div>
                    ...
                    <div className="mt-3">
                        <div className='flex justify-between items-center'>
                            <h1 className="text-l font-semibold">PHP and Laravel Developer</h1>
                            <h1 className="text-l font-semibold">May 2022 - Feb 2024</h1>
                        </div>
                        <div>
                ...
                <div className="areaofinterest mt-3">
                    ...
                    <div className="mt-2">
                        <div className='flex justify-between items-center'>
                            <h1 className="text-l font-semibold">Aayansh R Health Care</h1>
                        </div>
                        <div>
                    ...
                    <div className="mt-3">
                        <div className='flex justify-between items-center'>
                            <h1 className="text-l font-semibold">NSW Dogs</h1>
                        </div>
                        <div>
